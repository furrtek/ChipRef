...
const chipdef_t chipdefs[CHIPDEFS] = {
  ...
  // Moar MCUs !
  {"BD135",     "NPN BJT: ECB",    TRANS, &package_TO126,   0,                        trans_ecb},
  {"BD136",     "PNP BJT: ECB",    TRANS, &package_TO126,   0,                        trans_ecb},
  {"BC547B",    "NPN BJT: CBE",    TRANS, &package_TO92,    0,                        trans_cbe},
  {"BC557B",    "PNP BJT: CBE",    TRANS, &package_TO92,    0,                        trans_cbe},
  {"BC337",     "NPN BJT: CBE",    TRANS, &package_TO92,    0,                        trans_cbe},
  {"BC327",     "PNP BJT: CBE",    TRANS, &package_TO92,    0,                        trans_cbe},
  {"BC517",     "NPN Darl.: CBE",  TRANS, &package_TO92,    RESOURCE_ID_PDC_NPNDARL,  trans_cbe},
  {"BC516",     "PNP Darl.: CBE",  TRANS, &package_TO92,    RESOURCE_ID_PDC_PNPDARL,  trans_cbe},
  {"IRF520",    "N MOSFET: GDS",   TRANS, &package_TO220,   0,                        trans_gds},
  {"IRF640",    "N MOSFET: GDS",   TRANS, &package_TO220,   0,                        trans_gds},
  {"IRF9520",   "P MOSFET: GDS",   TRANS, &package_TO220,   0,                        trans_gds},
  {"IRL7833",   "N MOSFET: GDS",   TRANS, &package_TO220,   0,                        trans_gds},
  {"IRF4905",   "P MOSFET: GDS",   TRANS, &package_TO220,   0,                        trans_gds},
  {"2N3904",    "NPN BJT: EBC",    TRANS, &package_TO92,    0,                        trans_ebc},
  {"2N3906",    "PNP BJT: EBC",    TRANS, &package_TO92,    0,                        trans_ebc},
  {"TIP120",    "NPN Darl.: BCE",  TRANS, &package_TO220,   RESOURCE_ID_PDC_NPNDARL,  trans_bce},
  {"TIP125",    "PNP Darl.: BCE",  TRANS, &package_TO220,   RESOURCE_ID_PDC_PNPDARL,  trans_bce},
